...
def main() -> None:
    ...
    print(" Personal Capacity Facts deliberately kept out of THIS two-gate")
    print(" check for simplicity -- real data exists as of RE-043.1 and is")
    print(" per-patrimonio (AMS/AML, never merged); see audit_posture.py for")
    print(" the real three-gate, per-patrimonio version. Attested-judgement/")
    print(" Human Approval (RE-032.4) excluded always, has no code -- see")
    print(" engine/posture_mapper.py docstring)")
    print()
